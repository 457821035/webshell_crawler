...
class webshellPostSpiderPhpBackdoor(AbstractWebshellPostSpider):
    """
    webshell功能

    --  shell
    """
    name = "webshell_post_phpbackdoor"
    url = "http://10.108.114.132/dvwa/hackable/uploads/php-webshells-master/php-backdoor.php"
