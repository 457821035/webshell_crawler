...
class webshellPostSpiderDiveShell(AbstractWebshellPostSpider):
    """
    webshell功能

    --  shell
    """
    name = "webshell_post_DiveShell"
    url = "http://10.108.114.132/dvwa/hackable/uploads/php-webshells-master/Dive%20Shell%201.0%20-%20Emperor%20Hacking%20Team.php"
