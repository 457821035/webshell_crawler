...
class webshellPostSpiderEx0shell(AbstractWebshellPostSpider):
    """
    webshell功能

    --  shell
    """
    name = "webshell_post_Ex0shell"
    url = "http://10.108.114.132/dvwa/hackable/uploads/php-webshells-master/ex0shell.php"
