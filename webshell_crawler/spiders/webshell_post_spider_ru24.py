...
class webshellPostSpiderRu24(AbstractWebshellPostSpider):
    """
    webshell功能

    --  shell
    """
    name = "webshell_post_Ru24"
    url = "http://10.108.114.132/dvwa/hackable/uploads/php-webshells-master/ru24_post_sh.php"
