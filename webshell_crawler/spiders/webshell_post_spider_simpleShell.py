...
class webshellPostSpiderSimpleShell(AbstractWebshellPostSpider):
    """
    webshell功能

    --  shell
    """
    name = "webshell_post_SimpleShell"
    url = "http://10.108.114.132/dvwa/hackable/uploads/php-webshells-master/simple_cmd.php"
